...
def get_random_distorted_bottlenecks(
    ...
    for unused_i in range(how_many):
        ...
        bottleneck_values = sess.run(bottleneck_tensor,
                                     {resized_input_tensor: distorted_
                                     })
        bottleneck_values = np.squeeze(bottleneck_values)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='retrain_model/output_graph.pb',
        help='Where to save the trained graph.'
    )
    parser.add_argument(
        '--intermediate_output_graphs_dir',
        type=str,
        default='retrain_model/intermediate_graph/',
    ...
    parser.add_argument(
        '--output_labels',
        type=str,
        default='retrain_model/output_labels.txt',
        help='Where to save the trained graph\'s labels.'
    )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='retrain_model/retrain_logs',
    ...
    parser.add_argument(
        '--bottleneck_dir',
        type=str,
        default='retrain_model/bottleneck',
    ...
    parser.add_argument(
        '--checkpoint_path',
        type=str,
        default='retrain_model/_retrain_checkpoint',
