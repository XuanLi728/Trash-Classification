...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        #default='',
        default='E:/incptionV3_retrain/data/flower_photos',
    ...
    parser.add_argument(
        ...
        default='E:/incptionV3_retrain/retrain_model/output_graph.pb',
    ...
    parser.add_argument(
        ...
        default='E:/incptionV3_retrain/retrain_model/intermediate_graph/',
    ...
    parser.add_argument(
        ...
        default='E:/incptionV3_retrain/retrain_model/output_labels.txt',
    ...
    parser.add_argument(
        ...
        default='E:/incptionV3_retrain/retrain_model/retrain_logs',
    ...
    parser.add_argument(
        '--bottleneck_dir',
        type=str,
        default='E:/incptionV3_retrain/tmp/bottleneck',
    ...
    parser.add_argument(
        '--saved_model_dir',
        type=str,
        default='E:/incptionV3_retrain/retrain_model/',
    ...
    parser.add_argument(
        '--checkpoint_path',
        type=str,
        default='E:/incptionV3_retrain/tmp/_retrain_checkpoint',
